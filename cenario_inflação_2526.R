...
###############################################################################
projecao_autorregressiva <- function(serie_ts, rho = 0.914, meta = 3.00, ano_final = 2026, trimestre_final = 4) {
...
###############################################################################
criar_cenarios_hiato_exp <- function(arquivo_ods, sheet = 1, ano_final = 2026, tri_final = 4) {
